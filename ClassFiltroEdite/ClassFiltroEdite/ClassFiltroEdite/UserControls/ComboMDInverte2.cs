...
namespace ClassFiltroEdite.UserControls
{
    public partial class ComboMDInverte2 : UserControl
    {
        ...
        public ComboMDInverte2()
        {
            ...
            tabAnterior.Columns.Add("QUADRA", Type.GetType("System.String"));
            tabAnterior.Columns["QUADRA"].MaxLength = 3;
            ...
            */
            ...
            try
            {
                dataRow = tabAnterior.AsEnumerable().Where(row =>
                  (row.Field<string>("QUADRA").Trim() == textoNeto.Trim()) &&
                  (row.Field<string>("GLEBA").Trim() == textoFilho.Trim())
            ...
            if (dataRow == null)
            {
                ...
                dataRow["ID"] = idMax;
                dataRow["QUADRA"] = textoNeto;
                dataRow["GLEBA"] = textoFilho;
        ...
        public bool AtiveString()
        {
            ...
            if (cbNeto.Focused)
            {
                ...
                {
                    string quadra = orow["QUADRA"].ToString();
                
                    listBoxDialog.Lines.Add(quadra);
                }
                listBoxDialog.Title = "QUADRA";
