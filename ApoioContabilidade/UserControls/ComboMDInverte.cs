...
{
    public partial class ComboMDInverte : UserControl
    {
        public ComboMDInverte()
        {
            InitializeComponent();
           ...
           BindingSource obmDados, string ofieldNamePai, string ofieldNameFilho, string ofieldNameNeto, bool quadraValidaVazio = true)
        {
            ...
            // ComboPai.AutoCompleteMode = AutoCompleteMode.Suggest;
