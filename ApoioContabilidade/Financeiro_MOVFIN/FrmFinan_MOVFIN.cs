...
{
    public partial class FrmFinan_MOVFIN : Form
    {
        EventosDBF_Fin evt_Fin;
        EdtFinDBF comum;
        DataSet dsFiltrado;
       ...
       // DataSet dataSet1;
        ...
        private void Reload()
        {
            ...
            FiltroFinanDBF.PesquisaServidor(inicio, fim, oPesquisa, oList);

            // procedimeno para aglutinar registro


            dsFiltrado = FiltroFinanDBF.dsFinanceiro.Copy();

            evt_Fin = new EventosDBF_Fin(dsFiltrado);

            comum = new EdtFinDBF(evt_Fin);
   ...
   */
        ...
        private void MonteEdits()
        {
           ...
           // comum.EdtPagar.DeletaRegistrosAdapter += evt_Fin.EditeMovFin_DeletaRegistrosAdapter;

        }
        private void gbSaidas_Enter(object sender, EventArgs e)
        {
            if (evt_Fin.bmPagar == null) return;
        ...
        {
            if (evt_Fin.bmReceber == null) return;
        ...
        private  void toolStripMenuItemAprop_Click(object sender, EventArgs e)
        {
            int ent_sai = 0;
            ...
            if (oform.mudou)
            {
                bool result = frmFinanc_MOVFINConsulta.ConsultaServidor();
                if (!result) return;
        ...
        private  void toolStripMenuItemTransfere_Click(object sender, EventArgs e)
        {
           /* int ent_sai = 0;
            BindingSource bmDados = null;
            MonteGrid ogrid = null;   // datagridview do DESTINO (que irá receber a transferencia)
