...
namespace ApoioContabilidade.Financeiro.Imprimir
{
    public class ChequeImprime
    {
      ...
      //  private DataGridView TheDataGridView; // The DataGridView Control which will be printed
        ...
        public ChequeImprime(ChequeBradesco ochequeBradesco, PrintDocument aPrintDocument, 
               Font aTitleFont)
        {
            ...
            try
            {
                ...
                while (CurrentRow < chequeBradesco.cheques.Count)
                {
                    ...
                    if (contcheques == 0)
                    {
                         ...
                         incremente = 0;
                        // CurrentY = MMtoPixelY(e.Graphics,7) + (espaco * contcheques);
                        CurrentY = MMtoY(e, ( 7 + margemNegativo - 0.5)) + (espaco * contcheques);

                    }
                    else
                    {
                        // CurrentY  = MMtoPixelY(e.Graphics, 6) + (espaco * contcheques) + incremente;
                        CurrentY = MMtoY(e, (7 + margemNegativo - 0.5 ) + (espaco * contcheques) + incremente);
                    }
                    //
                    ...
                    CurrentY = MMtoY(e, (13 + margemNegativo)) + (espaco * contcheques) + incremente;   // 16
                    ...
                    if (ocheque.valores.Count > 1)
                    {
                        ...
                        tmpSize = e.Graphics.MeasureString(tcampo, RowFont);
                        CurrentY = MMtoY(e, (19 + margemNegativo)) + (espaco * contcheques) + incremente;   // 16
                  ...
                  //  CurrentX = MMtoPixelX(e.Graphics, 7 - 4);
                    CurrentY = MMtoY(e, (25 + margemNegativo)) + (espaco * contcheques) + incremente;   // 16
                    ...
                    //  CurrentY = MMtoPixelY(e.Graphics, 32) + (espaco * contcheques) + incremente;   // 16
                    // CurrentX = MMtoPixelX(e.Graphics, 75 - 5);
                    CurrentY = MMtoY(e, (32 + margemNegativo)) + (espaco * contcheques) + incremente;   // 16
                    ...
                    CurrentX = MMtoX(e, (162 + margemNegativo) -1 - 2.2); // - 8
