...
{
    public partial class FrmEdicaoMOVFIN : Form
    {
        ...
        Dictionary<string, string> dictDesc2;
        ...
        public FrmEdicaoMOVFIN()
        {
            ...
            // preenchido aqui
             ...
             dictDesc2 = new Dictionary<string, string>();
            ...
            {
                dictDesc2.Add(placon["DESC2"].ToString().Trim(), placon["DESCRICAO"].ToString().Trim());
        ...
        {
            tabelasDBF = TDataControlContab.EncontreTabela(true);
            if (tabelasDBF.Contains("MOVFIN.DBF"))
            {
                Anos.Add(0);
            }
            ...
            {
                MessageBox.Show("É necessario PTMOVFIN<ano>.DBF ou MOVFIN.DBF");
                return;
            }
        ...
        private void Reload()
        {
            ...
            if (comboBox1.SelectedItem.ToString() != "MOVFIN")
            {
            ...
            if (ano != AnoGeral)
            {
                ...
                if (comboBox1.Enabled)
                {
                    if (ano == 0)
                    {
                        ...
                        oForm.dtData1.Value = new DateTime(dataAtual.Year, dataAtual.Month, 1);
                        oForm.dtData2.Value = dataAtual;
      ...
      (from valor1 in movFinView.AsEnumerable()
       ...
       select valor1.Field<decimal>("VALOR")).Sum();
        ...
        private void MonteGrids()
        {
            ...
            oMovFin.AddValores("DEBITO", "DEBITO", 25, "", true, 0, "");
            oMovFin.AddValores("CREDITO", "CREDITO", 25, "", true, 0, "");
        ...
        private void MonteEdits()
        {
            try
            {
                ...
                */
                ...
                ocombox.DisplayMember = "DESC2";//  displayMember;
        ...
        void EditeMovFin_AlteraRegistrosOk(object sender, AlteraRegistroEventArgs e)
        {
            ...
            if (((orow["DEBITO"].ToString().Trim() == "") || (orow["CREDITO"].ToString().Trim() == ""))
        ...
        public List<string> PreenchaCamposValidos()
        {
            List<string> result;
               ...
               result = dictDesc2.AsEnumerable().Select(dic => dic.Key).ToList();
