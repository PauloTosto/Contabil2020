...
namespace WFAEstatiscaTrabalho


{

    
    class TAtualizaFolha
    {
        ...
        {
            oTabelasAux = TDataControlReduzido.TabelasCLT();
            FCLTCodigo = TDataControlReduzido.GetDict_CLTCodigo();
        ...
        public class TObjPonto:Object
       {
        ...
        public static DataTable ProvQuadra()
        {
            ...
            result.Columns.Add(Coluna(typeof(string), "SETOR", 2, false));
            result.Columns.Add(Coluna(typeof(string), "CENTRO", 4, false));
            result.Columns.Add(Coluna(typeof(string), "BL", 3, false));
            result.Columns.Add(Coluna(typeof(string), "TIPO", 1, false));   // "D"/"E"
            result.Columns.Add(Coluna(typeof(string), "NUM_MOD", 3, false));
            result.Columns.Add(Coluna(typeof(string), "CODSER", 3, false));
            result.Columns.Add(Coluna(typeof(DateTime), "PINICIO", 0, false));
            result.Columns.Add(Coluna(typeof(DateTime), "PFIM",  0, false));
            result.Columns.Add(Coluna(typeof(DateTime), "DTAINICIO",  0, false));
            result.Columns.Add(Coluna(typeof(DateTime), "DTAFIM",  0, false));
            result.Columns.Add(Coluna(typeof(Single), "HORAS", 0, false));
            result.Columns.Add(Coluna(typeof(Single), "DIARIAS",  0, false));
            result.Columns.Add(Coluna(typeof(Single), "QUANT",  0, false));
            result.Columns.Add(Coluna(typeof(Single), "PRODUT",  0, false));
            result.Columns.Add(Coluna(typeof(Single), "AREA",  0, false));
            result.Columns.Add(Coluna(typeof(Single), "PRODAREA",  0, false));
            return result;
        }
        ...
        public DataSet PegDadosEstatistica(DateTime inicio, DateTime fim)
        {
            ...
            //rever...
            return TDataControlReduzido.Get_CLTPontosPeriodo(linicio, lfim, "D");
    ...
    class csQuadras
    {
        ...
        public double area
        {
            get
            {
                ...
                if (farea == 0)
                    farea = Math.Round((2.333F * TDataControlReduzido.peghectares(fquadra)), 4);
                return farea;
            }
        }
        public double producao 
        {
            get 
            {
               ...
               if (fprod == 0)
                   fprod = TDataControlReduzido.pegcaixas(fquadra, finicio, ffim);
               return fprod; 
            }  
        }
         ...
         public double quant
        {
            get
            {
                ...
                if ((funid.Trim() == "PL") && (fcult.Trim() != ""))
                    result = TDataControlReduzido.pegplantas(fquadra, fcult);
                else
                    if (funid.Trim() == "TAR")
                        result = area;
                    else
